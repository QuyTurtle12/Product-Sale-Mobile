...
import com.example.product_sale_app.hai.cart.network.CartApiService;
import com.example.product_sale_app.hai.cart.network.RetrofitClient;
...
public class CartRepository {
    ...
    public void fetchCarts(int pageIndex, int pageSize, Integer idSearch, Integer userIdSearch, String statusSearch, CartCallback callback) {
        CartApiService api = RetrofitClient.createService(CartApiService.class);
